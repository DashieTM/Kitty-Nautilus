...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/term-nautilus.py https://raw.githubusercontent.com/DashieTM/Kitty-Nautilus/master/kitty-nautilus.py
